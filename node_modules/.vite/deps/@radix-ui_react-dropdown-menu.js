...
var Menu = (props) => {
  ...
  const isUsingKeyboardRef = React22.useRef(false);
  ...
  return (0, import_jsx_runtime9.jsx)(Root2, { ...popperScope, children: (0, import_jsx_runtime9.jsx)(
    MenuProvider,
    {
      ...
      children: (0, import_jsx_runtime9.jsx)(
        ...
        {
          scope: __scopeMenu,
          onClose: React22.useCallback(() => handleOpenChange(false), [handleOpenChange]),
          isUsingKeyboardRef,
          dir: direction,
          modal,
          children
...
var MenuAnchor = React22.forwardRef(
  (props, forwardedRef) => {
...
var MenuRootContentModal = React22.forwardRef(
  (props, forwardedRef) => {
    const context = useMenuContext(CONTENT_NAME2, props.__scopeMenu);
...
var MenuRootContentNonModal = React22.forwardRef((props, forwardedRef) => {
  const context = useMenuContext(CONTENT_NAME2, props.__scopeMenu);
  return (0, import_jsx_runtime9.jsx)(
    MenuContentImpl,
    {
...
var MenuContentImpl = React22.forwardRef(
  (props, forwardedRef) => {
    const {
      __scopeMenu,
      loop = false,
    ...
    const [currentItemId, setCurrentItemId] = React22.useState(null);
    const contentRef = React22.useRef(null);
    const composedRefs = useComposedRefs(forwardedRef, contentRef, context.onContentChange);
    const timerRef = React22.useRef(0);
    const searchRef = React22.useRef("");
    const pointerGraceTimerRef = React22.useRef(0);
    const pointerGraceIntentRef = React22.useRef(null);
    const pointerDirRef = React22.useRef("right");
    const lastPointerXRef = React22.useRef(0);
    const ScrollLockWrapper = disableOutsideScroll ? Combination_default : React22.Fragment;
    ...
    useFocusGuards();
    const isPointerMovingToSubmenu = React22.useCallback((event) => {
      var _a, _b;
    ...
    return (0, import_jsx_runtime9.jsx)(
      MenuContentProvider,
      {
        scope: __scopeMenu,
        searchRef,
        onItemEnter: React22.useCallback(
          (event) => {
            if (isPointerMovingToSubmenu(event)) event.preventDefault();
          },
          [isPointerMovingToSubmenu]
        ),
        onItemLeave: React22.useCallback(
          (event) => {
            var _a;
        ...
        onTriggerLeave: React22.useCallback(
          (event) => {
            if (isPointerMovingToSubmenu(event)) event.preventDefault();
          },
          [isPointerMovingToSubmenu]
        ...
        onPointerGraceIntentChange: React22.useCallback((intent) => {
...
var MenuGroup = React22.forwardRef(
  (props, forwardedRef) => {
...
var MenuLabel = React22.forwardRef(
  (props, forwardedRef) => {
...
var MenuItem = React22.forwardRef(
  (props, forwardedRef) => {
...
var MenuItemImpl = React22.forwardRef(
  (props, forwardedRef) => {
    ...
    const [textContent, setTextContent] = React22.useState("");
    React22.useEffect(() => {
      const menuItem = ref.current;
      if (menuItem) {
...
var MenuCheckboxItem = React22.forwardRef(
  (props, forwardedRef) => {
...
var MenuRadioGroup = React22.forwardRef(
  (props, forwardedRef) => {
...
var MenuRadioItem = React22.forwardRef(
  (props, forwardedRef) => {
...
var MenuItemIndicator = React22.forwardRef(
  (props, forwardedRef) => {
...
var MenuSeparator = React22.forwardRef(
  (props, forwardedRef) => {
...
var MenuArrow = React22.forwardRef(
  (props, forwardedRef) => {
...
var MenuSubTrigger = React22.forwardRef(
  (props, forwardedRef) => {
    const context = useMenuContext(SUB_TRIGGER_NAME, props.__scopeMenu);
    const rootContext = useMenuRootContext(SUB_TRIGGER_NAME, props.__scopeMenu);
    const subContext = useMenuSubContext(SUB_TRIGGER_NAME, props.__scopeMenu);
    const contentContext = useMenuContentContext(SUB_TRIGGER_NAME, props.__scopeMenu);
    const openTimerRef = React22.useRef(null);
    const { pointerGraceTimerRef, onPointerGraceIntentChange } = contentContext;
    const scope = { __scopeMenu: props.__scopeMenu };
    const clearOpenTimer = React22.useCallback(() => {
      if (openTimerRef.current) window.clearTimeout(openTimerRef.current);
      openTimerRef.current = null;
    }, []);
    React22.useEffect(() => clearOpenTimer, [clearOpenTimer]);
    React22.useEffect(() => {
...
var MenuSubContent = React22.forwardRef(
  (props, forwardedRef) => {
    const portalContext = usePortalContext(CONTENT_NAME2, props.__scopeMenu);
